...
#m2 = squirrel[squirrel$year == 2017, -5]
################################
...
analyze_yearly_trends(m1=m1, lag = 0,cutoff_estradiol = 150,
                      cutoff_progesterone = 20)

analyze_yearly_trends(m1=m2, lag = 0,cutoff_estradiol = 150,
                      cutoff_progesterone = 20)
