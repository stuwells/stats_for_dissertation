...
print(peakSummary)
write.csv(peakSummary, file='C:/Users/stuwe/Desktop/Stat analysis from stat lab/ovulation_summary.csv')

## Analyze squirrel data using
## Yearly analysis

jpeg('C:/Users/stuwe/Desktop/Stat analysis from stat lab/yearly_comparison.jpeg',    width = 900, height= 1200)
