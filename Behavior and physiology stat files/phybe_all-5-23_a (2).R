...
#                                     lty=2, xlab="Estradiol ng/gram",ylab="Agression"))
...
ggplot(estagr,aes(x=fe_est,y=mal_agr,color=(),+geom_smooth(),methods=glm(formula = mal_agr ~ mal_est_estug + I(mal_estug^2), family = "poisson", 
